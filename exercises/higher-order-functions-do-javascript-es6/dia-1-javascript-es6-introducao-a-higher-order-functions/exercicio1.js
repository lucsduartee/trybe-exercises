...
const generateEmail = nomePessoa => {
  emailPessoa = nomePessoa.replace(/\s/g, '_').toLowerCase();
  let obj = { 
...
const newEmployees = () => {
  const employees = {
    ...
    id3: generateEmail('Carla Paive'), // Nome: Carla Paiva -> Chame sua função passando o nome Carla Paiva como parâmetro, substituindo as aspas
  }
  return employees;
};
